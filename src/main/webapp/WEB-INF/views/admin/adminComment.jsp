...
<head>
    ...
    />
    <link rel="stylesheet" type="text/css" href="/css/admin/adminComment.css"/>
...
<div id="admin">
    ...
    <div id="admin_box">
        ...
        <div id="admin_menu">
            ...
            <a href="/adminJoin" style="color:white;" class="Btn3">참여관리</a>
        </div>
            ...
            <div class="col-12 d-flex flex-column justify-content-start" style="height: 500px">
                <div style="width: 800px;">
                    <h4 style="text-align: left;">
                        <a href="/adminComment" style="color: #00C471;">댓글관리</a>
                    </h4>
                </div>
                <form action="/adminComment" method="get" id="searchFrm">
                ...
                <div> <%-- class="overflow-auto"--%>
                    ...
                    <div style="margin-top:40px;" class="w-100">
                        <form method="post" action="/adminCommentDel" class="listMenuFrm">
                            <ul class="listMenu">
                                <li style="width:5%; border-bottom: 3px solid #ddd;">&nbsp;</li>
                                <li style="width:19%; border-bottom: 3px solid #ddd;">모집글번호</li>
                                <li style="width:38%; border-bottom: 3px solid #ddd;">댓글내용</li>
                                ...
                                <div class="listMenuFE">
                                    <c:forEach var="vo" items="${adminCommentList}">
                                        <li style="width:5%;" class="text-center"><input type='checkbox' name='noList' value='${vo.comment_no}' class="chk"/></li>
                                        <li style="width:19%;" class="text-center">${vo.no}</li>
                                        <li style="width:38%;" class="text-center">${vo.comment}</li>
                        ...
                        <ul class="paging">
                            ...
                            <c:if test="${apvo.pageNum>1}">
                                <li><a href="/adminComment?pageNum=${apvo.pageNum-1}
