				...
				<div class="containerList">
					...
					<!-- 검색 -->
						...
						<ul class="paging">
							...
							<!-- 페이지번호 -->
							<!-- ${bpvo.startPage} ${bpvo.startPage+bpvo.onePageCount-1}-->
							<c:forEach var="p" begin="${bpvo.startPage}" end="${bpvo.startPage+apvo.onePageCount-1}">
								<!--  총 페이지수보다 출력할 페이지번호가 작을때 -->
					            <c:if test="${p<=bpvo.totalPage}">
					            	<c:if test="${p==bpvo.pageNum}">
